...
export default function CardProjects() {
  ...
  const data = [
    ...
    {id:'2', cover:'Capa-projeto-3.png', title: 'Correto', description: 'Site de uma cafeteria feito em React.Js com uma interface envolvente e respomsiva. ',btnPrev: 'https://coffee-shop-kra3.vercel.app/', btnGitHub:'https://github.com/DevBrunomendoca/Coffee-Shop' },
  ...
  return(
    data.map((itens) => (
      <CardProjectsStyle key={itens.id}>
